...
public class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.ProductViewHolder> {
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.jan_product_list, null);
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(View itemView) {
            ...
            imageView = itemView.findViewById(R.id.jan_genericblock1);
            imageView2 = itemView.findViewById(R.id.jan_genericblock2);
            imageView3 = itemView.findViewById(R.id.jan_genericblock3);
            imageView4 = itemView.findViewById(R.id.jan_genericblock4);
            imageView5 = itemView.findViewById(R.id.jan_genericblock5);
            imageView6 = itemView.findViewById(R.id.jan_genericblock6);
            imageView7 = itemView.findViewById(R.id.jan_genericblock7);
            imageView8 = itemView.findViewById(R.id.jan_genericblock8);
            imageView9 = itemView.findViewById(R.id.jan_genericblock9);
            imageView10 = itemView.findViewById(R.id.jan_genericblock10);
            imageView11= itemView.findViewById(R.id.jan_genericblock11);
            imageView12= itemView.findViewById(R.id.jan_genericblock12);
            imageView13= itemView.findViewById(R.id.jan_genericblock13);
            imageView14= itemView.findViewById(R.id.jan_genericblock14);
            imageView15= itemView.findViewById(R.id.jan_genericblock15);
            imageView16= itemView.findViewById(R.id.jan_genericblock16);
            imageView17= itemView.findViewById(R.id.jan_genericblock17);
            imageView18= itemView.findViewById(R.id.jan_genericblock18);
            imageView19= itemView.findViewById(R.id.jan_genericblock19);
            imageView20= itemView.findViewById(R.id.jan_genericblock20);
            imageView21 = itemView.findViewById(R.id.jan_genericblock21);
            imageView22 = itemView.findViewById(R.id.jan_genericblock22);
            imageView23= itemView.findViewById(R.id.jan_genericblock23);
            imageView24= itemView.findViewById(R.id.jan_genericblock24);
            imageView25= itemView.findViewById(R.id.jan_genericblock25);
            imageView26= itemView.findViewById(R.id.jan_genericblock26);
            imageView27= itemView.findViewById(R.id.jan_genericblock27);
            imageView28= itemView.findViewById(R.id.jan_genericblock28);
            imageView29= itemView.findViewById(R.id.jan_genericblock29);
            imageView30= itemView.findViewById(R.id.jan_genericblock30);
            imageView31 = itemView.findViewById(R.id.jan_genericblock31);
            imageView32 = itemView.findViewById(R.id.jan_genericblock32);
            imageView33= itemView.findViewById(R.id.jan_genericblock33);
            imageView34 = itemView.findViewById(R.id.jan_genericblock34);
            imageView35= itemView.findViewById(R.id.jan_genericblock35);
            imageView36= itemView.findViewById(R.id.jan_img_header);
            imageView37= itemView.findViewById(R.id.jan_img_footer);
