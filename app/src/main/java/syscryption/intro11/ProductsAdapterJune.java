...
public class ProductsAdapterJune extends RecyclerView.Adapter<ProductsAdapterJune.ProductViewHolder>
{ private Context mCtx;
    private List<Product> productList;

    public ProductsAdapterJune(Context mCtx, List<Product> productList) {
        this.mCtx = mCtx;
        this.productList = productList;
    }

    @Override
    public ProductsAdapterJune.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.june_product_list, null);
        return new ProductsAdapterJune.ProductViewHolder(view);
    }


    public void onBindViewHolder(ProductsAdapterJune.ProductViewHolder holder, int position) {
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(View itemView) {
            ...
            imageView = itemView.findViewById(R.id.june_genericblock1);
            imageView2 = itemView.findViewById(R.id.june_genericblock2);
            imageView3 = itemView.findViewById(R.id.june_genericblock3);
            imageView4 = itemView.findViewById(R.id.june_genericblock4);
            imageView5 = itemView.findViewById(R.id.june_genericblock5);
            imageView6 = itemView.findViewById(R.id.june_genericblock6);
            imageView7 = itemView.findViewById(R.id.june_genericblock7);
            imageView8 = itemView.findViewById(R.id.june_genericblock8);
            imageView9 = itemView.findViewById(R.id.june_genericblock9);
            imageView10 = itemView.findViewById(R.id.june_genericblock10);
            imageView11= itemView.findViewById(R.id.june_genericblock11);
            imageView12= itemView.findViewById(R.id.june_genericblock12);
            imageView13= itemView.findViewById(R.id.june_genericblock13);
            imageView14= itemView.findViewById(R.id.june_genericblock14);
            imageView15= itemView.findViewById(R.id.june_genericblock15);
            imageView16= itemView.findViewById(R.id.june_genericblock16);
            imageView17= itemView.findViewById(R.id.june_genericblock17);
            imageView18= itemView.findViewById(R.id.june_genericblock18);
            imageView19= itemView.findViewById(R.id.june_genericblock19);
            imageView20= itemView.findViewById(R.id.june_genericblock20);
            imageView21 = itemView.findViewById(R.id.june_genericblock21);
            imageView22 = itemView.findViewById(R.id.june_genericblock22);
            imageView23= itemView.findViewById(R.id.june_genericblock23);
            imageView24= itemView.findViewById(R.id.june_genericblock24);
            imageView25= itemView.findViewById(R.id.june_genericblock25);
            imageView26= itemView.findViewById(R.id.june_genericblock26);
            imageView27= itemView.findViewById(R.id.june_genericblock27);
            imageView28= itemView.findViewById(R.id.june_genericblock28);
            imageView29= itemView.findViewById(R.id.june_genericblock29);
            imageView30= itemView.findViewById(R.id.june_genericblock30);
            imageView31 = itemView.findViewById(R.id.june_genericblock31);
            imageView32 = itemView.findViewById(R.id.june_genericblock32);
            imageView33= itemView.findViewById(R.id.june_genericblock33);
            imageView34 = itemView.findViewById(R.id.june_genericblock34);
            imageView35= itemView.findViewById(R.id.june_genericblock35);
            imageView36= itemView.findViewById(R.id.june_img_header);
            imageView37= itemView.findViewById(R.id.june_img_footer);
