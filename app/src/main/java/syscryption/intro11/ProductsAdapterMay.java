...
public class ProductsAdapterMay  extends RecyclerView.Adapter<ProductsAdapterMay.ProductViewHolder>
{ private Context mCtx;
    private List<Product> productList;

    public ProductsAdapterMay(Context mCtx, List<Product> productList) {
        this.mCtx = mCtx;
        this.productList = productList;
    }

    @Override
    public ProductsAdapterMay.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.may_product_list, null);
        return new ProductsAdapterMay.ProductViewHolder(view);
    }


    public void onBindViewHolder(ProductsAdapterMay.ProductViewHolder holder, int position) {
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(View itemView) {
            ...
            imageView = itemView.findViewById(R.id.may_genericblock1);
            imageView2 = itemView.findViewById(R.id.may_genericblock2);
            imageView3 = itemView.findViewById(R.id.may_genericblock3);
            imageView4 = itemView.findViewById(R.id.may_genericblock4);
            imageView5 = itemView.findViewById(R.id.may_genericblock5);
            imageView6 = itemView.findViewById(R.id.may_genericblock6);
            imageView7 = itemView.findViewById(R.id.may_genericblock7);
            imageView8 = itemView.findViewById(R.id.may_genericblock8);
            imageView9 = itemView.findViewById(R.id.may_genericblock9);
            imageView10 = itemView.findViewById(R.id.may_genericblock10);
            imageView11= itemView.findViewById(R.id.may_genericblock11);
            imageView12= itemView.findViewById(R.id.may_genericblock12);
            imageView13= itemView.findViewById(R.id.may_genericblock13);
            imageView14= itemView.findViewById(R.id.may_genericblock14);
            imageView15= itemView.findViewById(R.id.may_genericblock15);
            imageView16= itemView.findViewById(R.id.may_genericblock16);
            imageView17= itemView.findViewById(R.id.may_genericblock17);
            imageView18= itemView.findViewById(R.id.may_genericblock18);
            imageView19= itemView.findViewById(R.id.may_genericblock19);
            imageView20= itemView.findViewById(R.id.may_genericblock20);
            imageView21 = itemView.findViewById(R.id.may_genericblock21);
            imageView22 = itemView.findViewById(R.id.may_genericblock22);
            imageView23= itemView.findViewById(R.id.may_genericblock23);
            imageView24= itemView.findViewById(R.id.may_genericblock24);
            imageView25= itemView.findViewById(R.id.may_genericblock25);
            imageView26= itemView.findViewById(R.id.may_genericblock26);
            imageView27= itemView.findViewById(R.id.may_genericblock27);
            imageView28= itemView.findViewById(R.id.may_genericblock28);
            imageView29= itemView.findViewById(R.id.may_genericblock29);
            imageView30= itemView.findViewById(R.id.may_genericblock30);
            imageView31 = itemView.findViewById(R.id.may_genericblock31);
            imageView32 = itemView.findViewById(R.id.may_genericblock32);
            imageView33= itemView.findViewById(R.id.may_genericblock33);
            imageView34 = itemView.findViewById(R.id.may_genericblock34);
            imageView35= itemView.findViewById(R.id.may_genericblock35);
            imageView36= itemView.findViewById(R.id.may_img_header);
            imageView37= itemView.findViewById(R.id.may_img_footer);
