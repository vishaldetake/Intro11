...
public class ProductsAdapterDec extends RecyclerView.Adapter<ProductsAdapterDec.ProductViewHolder>
{ private Context mCtx;
    private List<Product> productList;

    public ProductsAdapterDec(Context mCtx, List<Product> productList) {
        this.mCtx = mCtx;
        this.productList = productList;
    }

    @Override
    public ProductsAdapterDec.ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.dec_product_list, null);
        return new ProductsAdapterDec.ProductViewHolder(view);
    }


    public void onBindViewHolder(ProductsAdapterDec.ProductViewHolder holder, int position) {
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(View itemView) {
            ...
            imageView = itemView.findViewById(R.id.dec_genericblock1);
            imageView2 = itemView.findViewById(R.id.dec_genericblock2);
            imageView3 = itemView.findViewById(R.id.dec_genericblock3);
            imageView4 = itemView.findViewById(R.id.dec_genericblock4);
            imageView5 = itemView.findViewById(R.id.dec_genericblock5);
            imageView6 = itemView.findViewById(R.id.dec_genericblock6);
            imageView7 = itemView.findViewById(R.id.dec_genericblock7);
            imageView8 = itemView.findViewById(R.id.dec_genericblock8);
            imageView9 = itemView.findViewById(R.id.dec_genericblock9);
            imageView10 = itemView.findViewById(R.id.dec_genericblock10);
            imageView11= itemView.findViewById(R.id.dec_genericblock11);
            imageView12= itemView.findViewById(R.id.dec_genericblock12);
            imageView13= itemView.findViewById(R.id.dec_genericblock13);
            imageView14= itemView.findViewById(R.id.dec_genericblock14);
            imageView15= itemView.findViewById(R.id.dec_genericblock15);
            imageView16= itemView.findViewById(R.id.dec_genericblock16);
            imageView17= itemView.findViewById(R.id.dec_genericblock17);
            imageView18= itemView.findViewById(R.id.dec_genericblock18);
            imageView19= itemView.findViewById(R.id.dec_genericblock19);
            imageView20= itemView.findViewById(R.id.dec_genericblock20);
            imageView21 = itemView.findViewById(R.id.dec_genericblock21);
            imageView22 = itemView.findViewById(R.id.dec_genericblock22);
            imageView23= itemView.findViewById(R.id.dec_genericblock23);
            imageView24= itemView.findViewById(R.id.dec_genericblock24);
            imageView25= itemView.findViewById(R.id.dec_genericblock25);
            imageView26= itemView.findViewById(R.id.dec_genericblock26);
            imageView27= itemView.findViewById(R.id.dec_genericblock27);
            imageView28= itemView.findViewById(R.id.dec_genericblock28);
            imageView29= itemView.findViewById(R.id.dec_genericblock29);
            imageView30= itemView.findViewById(R.id.dec_genericblock30);
            imageView31 = itemView.findViewById(R.id.dec_genericblock31);
            imageView32 = itemView.findViewById(R.id.dec_genericblock32);
            imageView33= itemView.findViewById(R.id.dec_genericblock33);
            imageView34 = itemView.findViewById(R.id.dec_genericblock34);
            imageView35= itemView.findViewById(R.id.dec_genericblock35);
            imageView36= itemView.findViewById(R.id.dec_img_header);
            imageView37= itemView.findViewById(R.id.dec_img_footer);
